...
const CATEGORY_META = {
  ...
  Frontend:               { color: "#2dd4bf", label: "Frontend" },
  Backend:                { color: "#818cf8", label: "Backend" },
  Databases:              { color: "#38bdf8", label: "Databases" },
  "GenAI & LLM Systems":  { color: "#fb7185", label: "GenAI & LLM Systems" },
